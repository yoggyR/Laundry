        ...
        <div class="container">
            <div class="row receptacle_customers">
                <div class="col-md-5">
                    ...
                    <form action="">
                        <div class="mb-2">
                            <input type="text" class="form-control form_search_customers_id" maxlength="10" placeholder="Customers id" autocomplete="off" required>
                        </div>
                        <p class="txt_notif_customers_id">Enter just 10 character customers id</p>
                        <a href="main.php?page=Data customers" class="btn btn-lg btn_search_customers_id" type="submit"><span class="txt_btn_search_customers_id">Search now</span></a>
                    </form>
                </div>
                <div class="col-md-5">
